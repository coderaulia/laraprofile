    ...
    <body class="bg-light-gray" id="body">
        <div class="container d-flex flex-column justify-content-between vh-100">
                        ...
                        <div class="card-header bg-primary">
                            <div class="app-brand">
                                <a href="/index.html">
                                    ...
                                    <span class="brand-name">Admin Panel Login</span>
                                </a>
                            </div>
                        </div>
                        @if(session('success'))
            ...
            <div class="copyright pl-0">
                <p class="text-center">&copy; 2021 Copyright <a class="text-primary" href="http://pro.auliasatriow.com" target="_blank">Little Box</a>.
                </p>
            </div>
        </div>
    </body>
